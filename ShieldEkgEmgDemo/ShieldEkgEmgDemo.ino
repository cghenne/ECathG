...
void setup() {
 ...
 TXBuf[0] = 0xaa;    //Sync 0
 TXBuf[1] = 0x02;    //CH1 High Byte
 TXBuf[2] = 0x00;    //CH1 Low Byte
...
void Timer2_Overflow_ISR()
{
  ...
  TXBuf[1] = ((unsigned char)((ADC_Value & 0xFF00) >> 8));	// Write High Byte
  TXBuf[2] = ((unsigned char)(ADC_Value & 0x00FF));	// Write Low Byte
